#!/usr/bin/env python3
"""
Startup script for KrishiVaani Market API
"""
...
if __name__ == "__main__":
    ...
    if not api_key:
        ...
        print("Please create a .env file with your Perplexity AI API key:")
        print("perplexity_api=your_perplexity_api_key_here")
        print("\nYou can get a free API key from: https://www.perplexity.ai/settings/api")
    
    print("🚀 Starting KrishiVaani Market API...")
